...
public class STLRIntermediateRepresentation : CustomStringConvertible {
    ...
    // MARK: -
    public enum Quantifier : CustomStringConvertible {
        case one
        case zeroOrOne
        case zeroOrMore
        case oneOrMore
    ...
    public indirect enum   Element : CustomStringConvertible{
        case terminal   (Terminal,   Quantifier, Bool, ElementAnnotations)
        case identifier (Identifier, Quantifier, Bool, ElementAnnotations)
        case group      (Expression, Quantifier, Bool, ElementAnnotations)
        
        init(_ terminal:Terminal, _ quantifier: Quantifier? = nil,_ annotations:ElementAnnotations? = nil){
            self = .terminal(terminal, quantifier ?? .one, false, annotations ?? ElementAnnotations())
        }
        
        init(_ identifier:Identifier, _ quantifier : Quantifier? = nil){
            self = .identifier(identifier, quantifier ?? .one, false, ElementAnnotations())
        }
        
        init(_ expression:Expression, _ quantifier : Quantifier? = nil){
...
public extension Collection where Iterator.Element == STLRIntermediateRepresentation.ElementAnnotationInstance{
    ...
    public func remove(_ annotation:STLRIntermediateRepresentation.ElementAnnotation)->STLRIntermediateRepresentation.ElementAnnotations{
        ...
        var cleaned = self.flatMap({ (annotationInstance)->STLRIntermediateRepresentation.ElementAnnotationInstance? in
